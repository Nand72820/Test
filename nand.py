...
CREATOR = "This File Is Made By @CREATIVEYDV"
...
def verify():
    ...
    if computed_hash != stored_hash:
        raise Exception("This File Is Made By @CREATIVEYDV.")
    print("This File Is Made By @CREATIVEYDV.")
...
def send_not_approved_message(chat_id):
    bot.send_message(chat_id, "*You Are Not Authorized DM @CREATIVEYDV ⚠*", parse_mode='Markdown')
...
def send_welcome(message):
    ...
    btn_attack = KeyboardButton("Server Freeze 💟")
    btn_account = KeyboardButton("Your Validity⚠️")
...
def echo_message(message):
    try:
        if message.text == "Server Freeze 💟":
            attack_command(message)
        elif message.text == "Your Validity⚠️":
            user_id = message.from_user.id
